...
// domain/interfaces/EngagementManager.ts
import { ReputationScore } from '../entities/ReputationScore';

export interface TwitterMention {
  // shape of a mention payload from Twitter
}

export interface EngagementManager {
  listenToMentions(): Promise<void>;
  analyzeUserReputation(userId: string): Promise<ReputationScore>;
  generateReply(mention: TwitterMention): Promise<string>;
}